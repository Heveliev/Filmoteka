...
//     else {
//         e.preventDefault;
//         const cardId = (e.target.parentNode.parentNode.parentNode.parentNode.id || 
...
//             const instance = basicLightbox.create(`<iframe width="80%" height="80%" src='https://www.youtube.com/embed/${idFilm}'frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>`, 
//             {
